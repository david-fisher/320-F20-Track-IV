...
function FinalAction(props) {
    ...
    function addFinalAction(history) {
        ...
        axios.post(`${baseURL}/api/v1/simulation/${props.scenarioData.id}/final-decision`, continuePromptData, {
            headers: {
        ...
        <div>
            ...
            <div className="second-body">
                ...
                <TextField
                    ...
                    label="Action Prompt"
                    style={{ margin: 8 }}
                    placeholder="Input your action prompt here"
                    helperText="This prompt sends the player to continue their project!"
                    fullWidth
                    variant="outlined"
                    multiline
                    margin="normal"
                ...
                <TextField
                    ...
                    helperText="This prompt sends the player to delay their project!"
                    fullWidth
                    variant="outlined"
                    multiline
                    margin="normal"
            ...
            <b2 className="third-body" >
                <div>
                    <Button type="editor-submit" title="SAVE" style={{ backgroundColor: '#881c1c', color: "white" }} onClick={addFinalAction}>SAVE</Button>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(FinalAction);
